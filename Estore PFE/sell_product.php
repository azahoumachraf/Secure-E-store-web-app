        ...
        <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="panel-heading"><h2>Les produits vendus</h2></div>
            ...
            ?>
                  ...
                  <td><a href="view_order.php?u_id=<?php echo $usur_id;?>?&& confirm_id=1?&& date=<?php echo $c_date?>">afficher</a> || <a href="?del_order_id=<?php echo $usur_id;?>?&showdate=<?php echo $show_date;?>">Supprimer</a></td>
            </tr>
       <?php }}?>
                </table>
              </div>
